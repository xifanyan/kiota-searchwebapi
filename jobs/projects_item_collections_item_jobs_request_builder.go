...
// ByJobId gets an item from the github.com/xifanyan/kiota-searchwebapi.jobs.projects.item.collections.item.jobs.item collection
...
func (m *ProjectsItemCollectionsItemJobsRequestBuilder) Get(ctx context.Context, requestConfiguration *ProjectsItemCollectionsItemJobsRequestBuilderGetRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.JobDescriptionListable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CreateJobDescriptionListFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.JobDescriptionListable), nil
}
...
func (m *ProjectsItemCollectionsItemJobsRequestBuilder) Post(ctx context.Context, body i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.JobSubmissionRequestable, requestConfiguration *ProjectsItemCollectionsItemJobsRequestBuilderPostRequestConfiguration)(*string, error) {
...
// returns a *RequestInformation when successful
func (m *ProjectsItemCollectionsItemJobsRequestBuilder) ToPostRequestInformation(ctx context.Context, body i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.JobSubmissionRequestable, requestConfiguration *ProjectsItemCollectionsItemJobsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
