...
func (m *ItemCollectionsItemCachedSearchesRequestBuilder) Delete(ctx context.Context, requestConfiguration *ItemCollectionsItemCachedSearchesRequestBuilderDeleteRequestConfiguration)([]i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CachedSearchDescriptionable, error) {
    requestInfo, err := m.ToDeleteRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CreateCachedSearchDescriptionFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    val := make([]i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CachedSearchDescriptionable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CachedSearchDescriptionable)
        }
    }
    return val, nil
}
...
// returns a []CachedSearchDescriptionable when successful
func (m *ItemCollectionsItemCachedSearchesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCollectionsItemCachedSearchesRequestBuilderGetRequestConfiguration)([]i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CachedSearchDescriptionable, error) {
...
// returns a []CachedSearchDescriptionable when successful
func (m *ItemCollectionsItemCachedSearchesRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemCollectionsItemCachedSearchesRequestBuilderPostRequestConfiguration)([]i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CachedSearchDescriptionable, error) {
