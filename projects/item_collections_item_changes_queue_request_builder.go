...
func (m *ItemCollectionsItemChangesQueueRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCollectionsItemChangesQueueRequestBuilderGetRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.WaitForPendingChangesResultable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CreateWaitForPendingChangesResultFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.WaitForPendingChangesResultable), nil
}
// Post change requests submitted with 'blockUntilComplete=false' are queued. Their value is immediately visible when fetching it, but searches are still based on their old state until the queue has been processed. This method allows to wait for queued change requests; more precisely: for all change requests which are queued (or in progress) at the time when this wait request is submitted.
// returns a WaitForPendingChangesResultable when successful
func (m *ItemCollectionsItemChangesQueueRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemCollectionsItemChangesQueueRequestBuilderPostRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.WaitForPendingChangesResultable, error) {
