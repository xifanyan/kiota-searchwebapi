...
func (m *ItemCollectionsItemFiltersItemValuesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCollectionsItemFiltersItemValuesRequestBuilderGetRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.FolderValuesResultable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CreateFolderValuesResultFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.FolderValuesResultable), nil
}
...
// returns a FolderValuesResultable when successful
func (m *ItemCollectionsItemFiltersItemValuesRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemCollectionsItemFiltersItemValuesRequestBuilderPostRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.FolderValuesResultable, error) {
