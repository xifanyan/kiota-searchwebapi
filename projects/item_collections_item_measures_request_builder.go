...
func (m *ItemCollectionsItemMeasuresRequestBuilder) Post(ctx context.Context, body []i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.DimensionRequestable, requestConfiguration *ItemCollectionsItemMeasuresRequestBuilderPostRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.MeasureCubeable, error) {
    requestInfo, err := m.ToPostRequestInformation(ctx, body, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CreateMeasureCubeFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.MeasureCubeable), nil
}
