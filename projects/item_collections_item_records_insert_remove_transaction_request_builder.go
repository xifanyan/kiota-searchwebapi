...
func (m *ItemCollectionsItemRecordsInsertRemoveTransactionRequestBuilder) Post(ctx context.Context, body i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.InsertRemoveRequestable, requestConfiguration *ItemCollectionsItemRecordsInsertRemoveTransactionRequestBuilderPostRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.InsertRemoveResultable, error) {
    requestInfo, err := m.ToPostRequestInformation(ctx, body, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CreateInsertRemoveResultFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.InsertRemoveResultable), nil
}
// ToPostRequestInformation creates new records in the specified collection. Note that this end point is intended to insert folders (=categories) into folder collections (=taxonomies). To this end, the projectId should be something like singleMindServer.NAME (or metaMindServer.NAME) and the collectionId should resemble the folder collection name (=taxonomy id). 
// returns a *RequestInformation when successful
func (m *ItemCollectionsItemRecordsInsertRemoveTransactionRequestBuilder) ToPostRequestInformation(ctx context.Context, body i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.InsertRemoveRequestable, requestConfiguration *ItemCollectionsItemRecordsInsertRemoveTransactionRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
