...
func (m *ItemCollectionsItemRecordsItemContentRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCollectionsItemRecordsItemContentRequestBuilderGetRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.Recordable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CreateRecordFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.Recordable), nil
}
// Post returns selected properties (possibly including paged body content) for the record in question.
// returns a Recordable when successful
func (m *ItemCollectionsItemRecordsItemContentRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemCollectionsItemRecordsItemContentRequestBuilderPostRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.Recordable, error) {
...
func (m *ItemCollectionsItemRecordsItemContentRequestBuilder) Put(ctx context.Context, body []i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.ChangeRequestable, requestConfiguration *ItemCollectionsItemRecordsItemContentRequestBuilderPutRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.ChangeResultable, error) {
    requestInfo, err := m.ToPutRequestInformation(ctx, body, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CreateChangeResultFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.ChangeResultable), nil
}
...
// returns a *RequestInformation when successful
func (m *ItemCollectionsItemRecordsItemContentRequestBuilder) ToPutRequestInformation(ctx context.Context, body []i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.ChangeRequestable, requestConfiguration *ItemCollectionsItemRecordsItemContentRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
