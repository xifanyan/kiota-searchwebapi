...
// ByRecordId gets an item from the github.com/xifanyan/kiota-searchwebapi.projects.item.collections.item.records.item collection
...
func (m *ItemCollectionsItemRecordsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCollectionsItemRecordsRequestBuilderGetRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.SearchResultable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CreateSearchResultFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.SearchResultable), nil
}
...
// returns a SearchResultable when successful
func (m *ItemCollectionsItemRecordsRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemCollectionsItemRecordsRequestBuilderPostRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.SearchResultable, error) {
...
func (m *ItemCollectionsItemRecordsRequestBuilder) Put(ctx context.Context, body []i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.ChangeRequestable, requestConfiguration *ItemCollectionsItemRecordsRequestBuilderPutRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.ChangeResultable, error) {
