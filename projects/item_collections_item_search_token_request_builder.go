...
func (m *ItemCollectionsItemSearchTokenRequestBuilder) Delete(ctx context.Context, body i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.SearchResultTokenable, requestConfiguration *ItemCollectionsItemSearchTokenRequestBuilderDeleteRequestConfiguration)([]byte, error) {
...
func (m *ItemCollectionsItemSearchTokenRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCollectionsItemSearchTokenRequestBuilderGetRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.SearchResultTokenResponseable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CreateSearchResultTokenResponseFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.SearchResultTokenResponseable), nil
}
// Post returns a referencable search token for the search.
// returns a SearchResultTokenResponseable when successful
func (m *ItemCollectionsItemSearchTokenRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemCollectionsItemSearchTokenRequestBuilderPostRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.SearchResultTokenResponseable, error) {
...
func (m *ItemCollectionsItemSearchTokenRequestBuilder) Put(ctx context.Context, body i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.SearchResultTokenable, requestConfiguration *ItemCollectionsItemSearchTokenRequestBuilderPutRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.SearchResultTokenResponseable, error) {
    requestInfo, err := m.ToPutRequestInformation(ctx, body, requestConfiguration);
    if err != nil {
        return nil, err
    }
    errorMapping := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ErrorMappings {
        "410": i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CreateSearchResultTokenResponseFromDiscriminatorValue,
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CreateSearchResultTokenResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *ItemCollectionsItemSearchTokenRequestBuilder) ToDeleteRequestInformation(ctx context.Context, body i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.SearchResultTokenable, requestConfiguration *ItemCollectionsItemSearchTokenRequestBuilderDeleteRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *ItemCollectionsItemSearchTokenRequestBuilder) ToPutRequestInformation(ctx context.Context, body i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.SearchResultTokenable, requestConfiguration *ItemCollectionsItemSearchTokenRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
