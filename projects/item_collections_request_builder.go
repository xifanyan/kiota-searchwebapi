...
// ByCollectionId gets an item from the github.com/xifanyan/kiota-searchwebapi.projects.item.collections.item collection
...
func (m *ItemCollectionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCollectionsRequestBuilderGetRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CollectionsResultable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CreateCollectionsResultFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CollectionsResultable), nil
}
// Post decisiv Search offers multiple domains (e.g. Documents, Matter, People, etc) belonging to a project. With this operation, the set of available domains is returned, e.g. for display as tabs in the UI. For any project that is not a non-merging meta-engine, the collection 'default' will be returned as the only collection.
// returns a CollectionsResultable when successful
func (m *ItemCollectionsRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemCollectionsRequestBuilderPostRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CollectionsResultable, error) {
