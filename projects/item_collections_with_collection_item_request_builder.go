...
func (m *ItemCollectionsWithCollectionItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCollectionsWithCollectionItemRequestBuilderGetRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CollectionResourcesResultable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CreateCollectionResourcesResultFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CollectionResourcesResultable), nil
}
...
// returns a CollectionResourcesResultable when successful
func (m *ItemCollectionsWithCollectionItemRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemCollectionsWithCollectionItemRequestBuilderPostRequestConfiguration)(i4eadb8137c655db471dd9174bc9e7e392dcdba3d1eda802a7656e87879605f9b.CollectionResourcesResultable, error) {
